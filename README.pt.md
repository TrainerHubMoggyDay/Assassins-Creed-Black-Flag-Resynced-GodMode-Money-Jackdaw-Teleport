...
**Baixar trainer Assassin's Creed Black Flag Resynced** — BlackSails · ACBFResynced · **v1.2.0**.
...
## Baixar trainer Assassin's Creed Black Flag Resynced
...
**O que há de novo no v1.2.0?**  
Ubisoft Connect fix. v1.1.0 fixed client attach.

**God Mode / dinheiro / teleporte / Jackdaw?**  
...
Apenas single-player. [TrainerHub MoggyDay](https://github.com/TrainerHubMoggyDay) não se responsabiliza.
